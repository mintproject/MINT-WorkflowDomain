...
Transform coordinates into latitude and longitudes and filter results for elements where land cover type as Cropland.
"
...
write.csv(DF, file = out_file, row.names=F)
