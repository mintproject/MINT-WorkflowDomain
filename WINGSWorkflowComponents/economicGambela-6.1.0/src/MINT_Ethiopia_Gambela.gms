$TITLE ETHIOPIA PMP REGIONAL(GAMBELLA) MODEL OF AGRICULTURAL PRODUCTION
* Ethiopia Agricultural Production Model
* Kelly M. Cobourn and Zeya Zhang, October 2019
* Virginia Tech
...
* Land use is for regional level in Ethiopia. The country is divided into
* 10 provices and 65 sub-regions. Land use is from AGSS report for 2013-14.
* Land areas are in ha. Fertilizer application level and yield level are
* included calibdata. This one focus on Gambella region.
table    calibdata(i,calib) observed land allocation
$ondelim
$include calibdata_Gam.csv
$offdelim
;
...
$ondelim
$include cyclesdata_Gam.csv
$offdelim
;

** Economic input files include crop prices are from FAOSTAT and are
...
file     MINT_Ethiopia_Gambela_calibout /MINT_Ethiopia_Gambela_calibration_output.txt/;
MINT_Ethiopia_Gambela_calibout.pc = 5;
put      MINT_Ethiopia_Gambela_calibout;
...
file     MINT_Ethiopia_Gambela_simout /MINT_Ethiopia_Gambela_simulation_output.txt/;
MINT_Ethiopia_Gambela_simout.pc = 5;
put      MINT_Ethiopia_Gambela_simout;
put      'year','region','crop','fert_subsidy (%)','land area (ha)',
         'production (kg)','yield (kg/ha)','Nuse (kg)','Nfert (kg/ha)'/;
loop(i, put '2014', 'gambella', i.tl, fertsubsidy(i), landarea(i),
