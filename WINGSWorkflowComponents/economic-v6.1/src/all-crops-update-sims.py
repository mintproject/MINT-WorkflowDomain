...
def _main():
	...
	maize_p = float(sys.argv[9]) / 100
	maize_c1 = float(sys.argv[10]) / 100
	maize_c2 = float(sys.argv[11]) / 100
	...
	a_p = [cassava_p,groundnuts_p,maize_p,sesame_p,sorghum_p]
	a_c1 = [cassava_c1,groundnuts_c1,maize_c1,sesame_c1,sorghum_c1]
	a_c2 = [cassava_c2,groundnuts_c2,maize_c2,sesame_c2,sorghum_c2]
